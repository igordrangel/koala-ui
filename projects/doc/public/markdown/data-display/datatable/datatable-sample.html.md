...
>
  <kl-datatable class="w-full h-full"
    ...
    <ng-container menu>
      <select class="select select-xs" [(ngModel)]="withPagination">
        <option [value]="true">Pagination Mode: Paginator</option>
        <option [value]="false">Pagination Mode: Load More</option>
      </select>
    </ng-container>
