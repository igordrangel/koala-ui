  ...
  template: `<app-dropdown insideClick>
    ...
    >
      <span class="flex flex-col items-center gap-1.5">
        <i class="fa-solid fa-font text-base" [class.opacity-70!]="!isActive()"></i>
...
export class FontColor extends ColorToolBase {
  readonly markName = 'textColor';
}
