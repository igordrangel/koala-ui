...
export const INPUT_CNPJ_PAGE = {
  pt: {
    title: 'Input CNPJ',
    description:
      'O Input CNPJ é um campo especializado para CNPJ (Cadastro Nacional da Pessoa Jurídica). Inclui validação de formato e regras do CNPJ, guiando o usuário e dando feedback imediato em caso de erro.',
    sections: {
      installation: {
        title: 'Instalação',
