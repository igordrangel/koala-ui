  ...
  pt: {
    ...
    sections: {
      ...
      variants: {
        title: 'Variantes',
        description:
          'O componente range oferece várias variantes para diferentes casos de uso e requisitos de design.',
      },
      sizes: {
        title: 'Tamanhos',
        description:
          'O componente range oferece tamanhos diferentes para várias necessidades de design.',
      },
      disabled: {
        title: 'Desabilitado',
        description:
  ...
  en: {
    ...
    sections: {
      ...
      variants: {
        title: 'Variants',
        description:
          'The range component supports several variants to fit different use cases and design requirements.',
      },
      sizes: {
        title: 'Sizes',
        description:
          'The range component supports different sizes to accommodate various design needs.',
      },
      disabled: {
        title: 'Disabled',
        description:
