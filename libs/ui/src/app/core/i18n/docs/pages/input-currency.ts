...
export const INPUT_CURRENCY_PAGE = {
  pt: {
    title: 'Currency',
    description: 'O componente Currency é um campo especializado para valores monetários. Inclui validação de formato e regras de moeda, guiando o usuário e dando feedback imediato em caso de erro.',
    sections: {
      installation: {
        title: 'Instalação',
