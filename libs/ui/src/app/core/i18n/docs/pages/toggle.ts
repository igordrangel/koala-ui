...
export const TOGGLE_PAGE = {
  pt: {
    ...
    sections: {
      ...
      variants: {
        title: 'Variantes',
        description: 'O componente toggle oferece várias variantes para diferentes casos de uso e requisitos de design.',
      },
      sizes: {
        title: 'Tamanhos',
        description: 'O componente toggle oferece tamanhos diferentes para várias necessidades de design.',
      },
      disabled: {
        title: 'Desabilitado',
  ...
  en: {
    ...
    sections: {
      ...
      variants: {
        title: 'Variants',
        description: 'The toggle component supports several variants to fit different use cases and design requirements.',
      },
      sizes: {
        title: 'Sizes',
        description: 'The toggle component supports different sizes to accommodate various design needs.',
      },
      disabled: {
        title: 'Disabled',
