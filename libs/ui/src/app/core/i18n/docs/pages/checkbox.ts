...
export const CHECKBOX_PAGE = {
  pt: {
    ...
    sections: {
      ...
      variants: {
        title: 'Variantes',
        description: 'O componente checkbox oferece várias variantes para diferentes casos de uso e requisitos de design.',
      },
      sizes: {
        title: 'Tamanhos',
        description: 'O componente checkbox oferece tamanhos diferentes para atender a várias necessidades de design.',
      },
      disabled: {
        title: 'Desabilitado',
  ...
  en: {
    ...
    sections: {
      ...
      variants: {
        title: 'Variants',
        description: 'The checkbox component supports several variants to fit different use cases and design requirements.',
      },
      sizes: {
        title: 'Sizes',
        description: 'The checkbox component supports different sizes to accommodate various design needs.',
      },
      disabled: {
        title: 'Disabled',
